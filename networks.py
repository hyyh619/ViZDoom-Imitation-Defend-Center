...
from keras.layers import Conv2D, Convolution2D, Dense, Flatten, merge, MaxPooling2D, Input, AveragePooling2D, Lambda, Merge, Activation, Embedding
...
class Networks(object):
    ...
    def value_distribution_network(input_shape, num_atoms, action_size, learning_rate):
        ...
        cnn_feature = Conv2D(32, (8, 8), strides=(4,4), activation='relu')(state_input)
        cnn_feature = Conv2D(64, (4, 4), strides=(2,2), activation='relu')(cnn_feature)
